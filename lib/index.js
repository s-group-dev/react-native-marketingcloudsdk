...
class MCReactModule {
     ...
     * the device.
     * @param  {string | null} token - The Firebase or APN token to be used by Marketing Cloud
     ...
     * being displayed.
     */
    static isMarketingCloudPush(remoteMessage) {
        if (Platform.OS === 'android') {
            return RNMarketingCloudSdk.isMarketingCloudPush(remoteMessage);
        }
